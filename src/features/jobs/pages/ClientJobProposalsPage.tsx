      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div className="space-y-2">
           ...
           <div className="flex items-center gap-4 text-sm font-medium text-slate-500">
              ...
              <span className="bg-primary/10 text-primary px-3 py-0.5 rounded-full text-[10px] font-black uppercase">Open for Bidding</span>
           </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-2 space-y-6">
           <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 p-1 bg-slate-100 rounded-[18px]">
                 {(['all', 'best', 'shortlisted'] as const).map(tab => (
                   <button 
                     key={tab}
                     onClick={() => setActiveTab(tab)}
                     className={cn(
                       "px-6 py-2 rounded-[14px] text-xs font-black capitalize transition-all",
        ...
        <div className="lg:col-span-1 space-y-6">
           <div className="bg-brand-blue-dark rounded-[32px] p-8 text-white relative overflow-hidden shadow-2xl shadow-blue-900/20">
              ...
              <div className="relative z-10 space-y-6">
                 ...
                 <div className="pt-4 border-t border-white/10 space-y-4">
                    <p className="text-[10px] font-bold text-blue-200/50 uppercase tracking-widest">Last analysis: 2 hours ago</p>
