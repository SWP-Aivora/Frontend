...
export const DisputeDetailPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f0f4f9] pb-20 animate-in fade-in duration-500">
      {/* Top Header Navigation */}
      <div className="bg-white border-b border-slate-100 sticky top-0 z-30 px-8 py-4">
      ...
      <div className="max-w-7xl mx-auto px-8 mt-8 grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
