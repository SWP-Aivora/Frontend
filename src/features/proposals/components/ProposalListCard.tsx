        ...
        <div className="flex flex-row md:flex-col justify-end md:justify-start gap-2 shrink-0 md:w-[132px] pt-4 md:pt-0">
           {isAccepted ? (
             <div className="flex flex-col gap-2 w-full">
               {detailHref && (
                 <Button asChild variant="outline" className="md:w-full rounded-xl font-bold h-10 border-slate-200">
                   <Link to={detailHref}>
                     View Details
             ...
             <>
               {canChangeStatus && !isRefused && (
                 <Button
                   ...
                   className="flex-1 md:w-full rounded-xl font-bold h-10 border-rose-200 bg-rose-50 text-rose-700 hover:bg-rose-100 hover:text-rose-800"
                 >
                   Refuse
                 </Button>
               )}
               {isRefused && detailHref && (
                 <Button asChild variant="outline" className="flex-1 md:w-full rounded-xl font-bold h-10 border-slate-200">
                   <Link to={detailHref}>
                     View Details
                     <ExternalLink className="size-3.5 ml-1" />
                   </Link>
