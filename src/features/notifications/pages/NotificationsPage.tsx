...
export const NotificationsPage = () => {
  ...
  return (
    <div className="flex flex-col gap-6 max-w-7xl mx-auto w-full pb-8">
      {/* Hero Section */}
      <div className="bg-white border border-slate-200 rounded-[28px] p-8 relative overflow-hidden shadow-sm flex flex-col md:flex-row gap-6 md:items-center justify-between">
        <div className="absolute top-0 left-0 w-[300px] h-full bg-blue-50/80 -z-10" />
        
        <div className="flex items-center gap-6 z-10">
          <div className="size-14 bg-primary rounded-2xl flex items-center justify-center shadow-md">
            <span className="text-white font-bold text-2xl">N</span>
          </div>
          <div>
            <div className="bg-blue-50 border border-primary/20 px-3 py-1 rounded-full w-fit mb-2">
              <span className="text-[10px] font-bold text-primary uppercase">SHARED CENTER</span>
            </div>
        ...
        <div className="flex items-center gap-4 z-10">
          <div className="bg-primary text-white rounded-[24px] p-4 text-center min-w-[120px] shadow-sm">
            <p className="text-3xl font-bold">{unreadCount}</p>
            <p className="text-[11px] font-semibold mt-1">Unread alerts</p>
          </div>
      ...
      <div className="flex flex-col xl:flex-row gap-6">
        ...
        <div className="w-full xl:w-[320px] shrink-0 flex flex-col gap-4">
          <div className="bg-red-50 rounded-[18px] p-5 border border-red-100">
            <div className="bg-red-100 text-red-600 px-3 py-1 rounded-full w-fit mb-3">
              <span className="text-[10px] font-bold uppercase">3 ACTIVE</span>
            </div>
          ...
          <div className="bg-white border border-slate-200 rounded-[16px] p-4 flex items-center justify-between">
          ...
          <div className="bg-white border border-slate-200 rounded-[16px] p-4 flex items-center justify-between">
            ...
            <span className="text-[11px] font-medium text-slate-500">1 case open</span>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-[16px] p-4 flex items-center justify-between">
            ...
            <span className="text-[11px] font-medium text-slate-500">2 requests</span>
          </div>

          <button className="bg-blue-50 border border-blue-100 text-primary rounded-full py-2.5 px-4 text-[11px] font-semibold flex items-center justify-between hover:bg-blue-100 transition-colors mt-2">
