      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between p-4 bg-slate-50 rounded-lg border border-slate-100">
          <div className="flex items-center gap-3">
            <div className="size-10 rounded-lg bg-white border border-slate-200 flex items-center justify-center font-black text-xs">VISA</div>
            <div>
        ...
        <Button variant="ghost" className="w-full rounded-lg border border-dashed border-slate-200 text-slate-500 hover:bg-slate-50">
          + Add New Method
        </Button>
      </div>
    </div>
