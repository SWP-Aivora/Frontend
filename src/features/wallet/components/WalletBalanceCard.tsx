...
export const WalletBalanceCard = ({ balance, inEscrow, totalStats, isClient }: WalletBalanceCardProps) => {
  return (
    <div className="relative h-64 rounded-lg bg-brand-blue-dark p-10 text-white overflow-hidden shadow-2xl">
      {/* Background Shapes */}
      <div className="absolute top-0 right-0 size-80 bg-blue-400/20 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/2" />
      ...
      <div className="relative z-10 h-full flex flex-col justify-between">
        <div className="flex justify-between items-start">
          ...
          <div className="size-14 rounded-lg bg-white/10 backdrop-blur-md flex items-center justify-center border border-white/10">
