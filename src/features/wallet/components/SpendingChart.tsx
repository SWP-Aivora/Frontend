...
export const SpendingChart = ({ transactions, isClient }: SpendingChartProps) => {
  ...
  return (
    <div className="flex h-full min-h-[320px] w-full min-w-0 flex-col rounded-md border border-slate-100 bg-white p-5 shadow-sm">
      <div className="mb-3 flex items-center justify-between gap-4">
        <h3 className="text-base font-black text-slate-900">{isClient ? 'Weekly Wallet Flow' : 'Weekly Earning Flow'}</h3>
