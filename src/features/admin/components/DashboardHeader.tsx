      ...
      <div className="flex flex-col lg:flex-row items-stretch">
        ...
        <div className="p-6 lg:w-fit flex flex-col justify-center gap-3 border-l border-slate-100">
          <Link
            ...
            className="flex items-center justify-center px-4 py-2 bg-white border border-primary/20 text-primary rounded-xl font-black text-sm hover:bg-primary/5 hover:border-primary transition-all whitespace-nowrap shadow-sm"
          >
