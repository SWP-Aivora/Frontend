    ...
    <div className="h-screen w-full bg-white relative overflow-hidden flex items-center justify-center p-4 lg:p-6 font-sans selection:bg-primary/10">
      ...
      <div className="container relative z-10 grid h-full max-h-[820px] w-full max-w-6xl items-stretch gap-6 lg:grid-cols-[0.82fr_1fr]">
        ...
        <div className="hidden lg:flex flex-col bg-gradient-to-br from-brand-blue-light/80 to-white/40 backdrop-blur-xl border border-white/50 rounded-panel p-8 shadow-2xl relative overflow-hidden animate-slide-in-left">
          ...
          {/* Content */}
          <div className="space-y-4 mb-6 opacity-0 animate-fade-in [animation-delay:600ms]">
          ...
          <div className="relative mt-auto h-[210px] flex items-center justify-center opacity-0 animate-slide-up [animation-delay:800ms]">
             <div className="absolute inset-0 bg-primary/5 rounded-lg -rotate-2 scale-105 blur-2xl" />
             <div className="relative bg-white border border-border/60 rounded-lg shadow-2xl w-[380px] p-4 overflow-hidden animate-float">
                <div className="flex items-center mb-4">
                  <span className="text-base font-bold">Role Redirects</span>
                </div>
                
                {/* Visual Elements */}
                <div className="h-2 w-full bg-slate-100 rounded-full mb-5 relative overflow-hidden">
                ...
                {/* Mini Bars Chart */}
                <div className="flex items-end gap-2 h-12 pt-3 border-t border-slate-100">
          ...
          {/* Workspace Tags */}
          <div className="grid grid-cols-3 gap-3 mt-6 opacity-0 animate-fade-in [animation-delay:1000ms]">
            {[
              ...
              <div key={i} className="p-3 rounded-lg bg-white border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
        ...
        <div className="flex flex-col justify-center items-center py-0">
          <div className="w-full max-w-[560px] bg-white rounded-lg p-7 sm:p-9 shadow-2xl border border-slate-100 relative opacity-0 animate-slide-up [animation-delay:300ms]">
            <div className="space-y-6">
              <div className="space-y-3">
                <p className="text-xs font-bold text-primary tracking-widest uppercase">Login Page — AIVORA</p>
                <h2 className="text-3xl font-black text-foreground tracking-tight">Welcome Back to AIVORA</h2>
